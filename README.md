...
កាត់ផ្ទៃខាងក្រោយចេញ + បម្លែងរូបភាពទៅជា URL + Copy អក្សរពីរូបភាព (OCR) តាមរយៈ Telegram (ភាសាខ្មែរ)។
...
## Rate Limiting + Referral

មុខងារនីមួយៗ (ស្វែងរក, TTS, ធ្វើរូបភាពច្បាស់, កាត់ផ្ទៃខាងក្រោយ, រូបភាពទៅ URL) កំណត់ត្រឹម
**2 ដងក្នុងរយៈពេល 12 ម៉ោង** ក្នុងមួយ user។ ពេលអស់ quota, Bot នឹងបង្ហាញ link ណែនាំមិត្ត — រាល់ครั้ง
មិត្តម្នាក់ chat ជាមួយ bot តាម link នោះ, អ្នកណែនាំទទួលបាន **+2 ដងបន្ថែម** ស្វ័យប្រវត្តិ។ Admin
(តាម `ADMIN_IDS`) មិនកំណត់ទេ។ អ្នកប្រើអាចមើល link ណែនាំខ្លួនឯង + ស្ថិតិ bonus តាមរយៈ `/referral`។
